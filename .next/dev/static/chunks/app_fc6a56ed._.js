...
"[project]/app/tools/salary-calculator/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SalaryCalculatorPage() {
    ...
    const [salaryType, setSalaryType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("gross");
    const calculateSalary = ()=>{
        const baseSalary = parseFloat(salary.replace(/,/g, "")) || 0;
        if (salaryType === "gross") {
            const socialIns = baseSalary * 0.08;
            const healthIns = baseSalary * 0.015;
            const unemploymentIns = baseSalary * 0.01;
            const taxIncome = baseSalary - socialIns - healthIns - unemploymentIns - 11000000;
            let personalTax = 0;
            if (taxIncome > 0) {
                if (taxIncome <= 5000000) personalTax = taxIncome * 0.05;
                else if (taxIncome <= 10000000) personalTax = 250000 + (taxIncome - 5000000) * 0.1;
                else if (taxIncome <= 18000000) personalTax = 750000 + (taxIncome - 10000000) * 0.15;
                else if (taxIncome <= 32000000) personalTax = 1950000 + (taxIncome - 18000000) * 0.2;
                else if (taxIncome <= 52000000) personalTax = 4750000 + (taxIncome - 32000000) * 0.25;
                else if (taxIncome <= 78000000) personalTax = 9750000 + (taxIncome - 52000000) * 0.3;
                else personalTax = 17550000 + (taxIncome - 78000000) * 0.35;
            }
            const netSalary = baseSalary - socialIns - healthIns - unemploymentIns - personalTax;
            return {
                gross: baseSalary,
                net: netSalary,
                socialIns,
            ...
            const gross = baseSalary * 1.2;
            const socialIns = gross * 0.08;
            const healthIns = gross * 0.015;
            const unemploymentIns = gross * 0.01;
            const taxIncome = gross - socialIns - healthIns - unemploymentIns - 11000000;
            let personalTax = 0;
            if (taxIncome > 0) {
                if (taxIncome <= 5000000) personalTax = taxIncome * 0.05;
                else if (taxIncome <= 10000000) personalTax = 250000 + (taxIncome - 5000000) * 0.1;
            ...
            return {
                gross,
                net: baseSalary,
                socialIns: gross * 0.08,
                healthIns: gross * 0.015,
                unemploymentIns: gross * 0.01,
                personalTax,
                takeHome: baseSalary
            };
        }
    };
    const result = salary ? calculateSalary() : null;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$Navbar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/app/tools/salary-calculator/page.tsx",
                lineNumber: 63,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Tính toán lương thực nhận từ lương Gross hoặc ngược lại"
                        }, void 0, false, {
                            fileName: "[project]/app/tools/salary-calculator/page.tsx",
                            lineNumber: 71,
                            columnNumber: 21
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            style: {
                                                ...
                                                border: "none",
                                                borderRadius: "6px",
                                                background: salaryType === "gross" ? "var(--primary)" : "transparent",
                                                color: salaryType === "gross" ? "#fff" : "var(--text-muted)",
                                                fontWeight: 600,
                                                cursor: "pointer",
                                                transition: "all 0.2s"
                                            },
                                            children: "Lương Gross"
                                        }, void 0, false, {
                                            fileName: "[project]/app/tools/salary-calculator/page.tsx",
                                            lineNumber: 83,
                                            columnNumber: 33
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            style: {
                                                ...
                                                border: "none",
                                                borderRadius: "6px",
                                                background: salaryType === "net" ? "var(--primary)" : "transparent",
                                                color: salaryType === "net" ? "#fff" : "var(--text-muted)",
                                                fontWeight: 600,
                                                cursor: "pointer",
                                                transition: "all 0.2s"
                                            },
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: salaryType === "gross" ? "Lương Gross là tổng lương trước thuế và bảo hiểm" : "Lương Net là số tiền bạn thực nhận hàng tháng"
                                        }, void 0, false, {
                                            fileName: "[project]/app/tools/salary-calculator/page.tsx",
                                            lineNumber: 123,
                                            columnNumber: 33
                                ...
                                result && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: formatCurrency(result.takeHome)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/tools/salary-calculator/page.tsx",
                                                                    lineNumber: 145,
                                                                    columnNumber: 49
                                                                ...
                                                                [
                                                                    {
                                                                        ...
                                                                        value: result.socialIns
                                                                    },
                                                                    {
                                                                        label: "Bảo hiểm y tế (1.5%)",
                                                                        value: result.healthIns
                                                                    },
                                                                    {
                                                                        label: "Bảo hiểm thất nghiệp (1%)",
                                                                        value: result.unemploymentIns
                                                                    }
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "* Đây là tính toán ước lượng, có thể không chính xác 100%"
                                        }, void 0, false, {
                                            fileName: "[project]/app/tools/salary-calculator/page.tsx",
                                            lineNumber: 170,
                                            columnNumber: 37
...
_s(SalaryCalculatorPage, "e56BI/jh0DTa1SJ78WbqMmgFxDM=");
_c = SalaryCalculatorPage;
var _c;
__turbopack_context__.k.register(_c, "SalaryCalculatorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_fc6a56ed._.js.map