                        ...
                        <div>
                            ...
                            <div className="card" style={{ padding: "2rem", marginBottom: "1.5rem" }}>
                                <div style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start", marginBottom: "1.5rem", flexWrap: "wrap" }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <h1 style={{ fontSize: "clamp(1.25rem, 2.5vw, 1.75rem)", fontWeight: 800, color: "var(--text)", marginBottom: "0.375rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                                            {job.title}
                                            {job.isVip && (
                                                <span style={{ fontSize: "0.65rem", backgroundColor: "#FEF08A", color: "#A16207", padding: "2px 8px", borderRadius: "100px", fontWeight: "bold", border: "1px solid #FDE047", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                                                    ✨ VIP
                                                </span>
                                            )}
                                        </h1>
