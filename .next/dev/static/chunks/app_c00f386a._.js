        ...
        "Home.useEffect": ()=>{
            const interval = setInterval({
                "Home.useEffect.interval": ()=>{
                    setWordIndex({
                        "Home.useEffect.interval": (prev)=>(prev + 1) % HERO_WORDS.length
                    }["Home.useEffect.interval"]);
                }
            }["Home.useEffect.interval"], 2500);
            return ({
...
_s(Home, "OFvGKZ+tzN0VWbjuIPz8U2OVF54=");
_c = Home;
var _c;
...
//# sourceMappingURL=app_c00f386a._.js.map