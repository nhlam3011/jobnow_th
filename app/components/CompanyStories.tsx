...
// A pool of videos to rotate/select from based on company
const VIDEO_POOL = [
    "https://assets.mixkit.co/videos/preview/mixkit-software-developer-working-on-code-at-night-40439-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-young-woman-working-at-a-coffee-shop-40114-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-young-man-having-a-remote-meeting-on-his-laptop-40096-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-business-people-shaking-hands-at-a-meeting-40428-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-software-engineer-working-at-his-desk-40432-large.mp4",
];

const CONTENT_TEMPALTES = [
...
export default function CompanyStories({ companyName = "Doanh nghiệp" }: CompanyStoriesProps) {
    ...
    const stories = useMemo(() => {
        ...
        return [0, 1, 2].map(i => {
            const videoIdx = (absHash + i) % VIDEO_POOL.length;
            const contentIdx = (absHash + i) % CONTENT_TEMPALTES.length;
            const template = CONTENT_TEMPALTES[contentIdx];
            
            return {
                id: `${absHash}-${i}`,
                videoUrl: VIDEO_POOL[videoIdx],
