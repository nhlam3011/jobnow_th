    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const valid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, user.password);
    ...
    callbacks: {
        async signIn ({ user, account }) {
            if (account?.provider === "google") {
                const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                    where: {
                        email: user.email
                    }
                });
                if (!existingUser) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["prisma"].user.create({
                        data: {
                            email: user.email,
                            name: user.name,
                            image: user.image,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56a39d2c._.js.map