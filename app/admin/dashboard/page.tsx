    ...
    return (
        ...
        >
            ...
            <div className="dash-stats">
                {[
                    { label: "Tổng người dùng", value: s.users || 0, color: "#0369A1", icon: "M17 20h5v-2a3 3 0 0 0-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 0 1 5.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 0 1 9.288 0M15 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0z", href: "/admin/users" },
                    { label: "Tổng việc làm", value: s.jobs || 0, color: "#22C55E", icon: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2", href: "/admin/jobs" },
                    { label: "Tổng doanh thu", value: (billing.totalDeposit || 0).toLocaleString("vi-VN") + " đ", color: "#10B981", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z", href: "/admin/billing" },
                    { label: "Chờ duyệt", value: s.pendingJobs || 0, color: "#F59E0B", icon: "M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0z", href: "/admin/jobs?status=PENDING" },
                ].map((stat) => (
