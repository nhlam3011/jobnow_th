...
function BlogDetailClient({ blog }) {
    const relatedBlogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blogs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBlogsByCategory"])(blog.category).filter((b)=>b.id !== blog.id).slice(0, 3);
    const recentBlogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blogs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRecentBlogs"])(4).filter((b)=>b.id !== blog.id);
...
//# sourceMappingURL=_7f881dcd._.js.map